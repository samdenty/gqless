...
From previously working on a large GraphQL codebase, the repetition involved with shipping new features often slowed me down.

## What

**gqless** is a fundamentally new approach to a GraphQL client. It makes using your API enjoyable, by **generating queries at runtime**.
...
I set out to create a GraphQL client that lets you *forget you're using GraphQL*.
