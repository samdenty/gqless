...
test('basic functionality', async () => {
  ...
  expect(dataBackup1).toMatchInlineSnapshot(
    `"{\\"cache\\":{\\"query\\":{\\"human0\\":{\\"__typename\\":\\"Human\\",\\"id\\":\\"1\\",\\"name\\":\\"asd\\"}}},\\"normalizedCache\\":{\\"Human1\\":{\\"__typename\\":\\"Human\\",\\"id\\":\\"1\\",\\"name\\":\\"asd\\"}},\\"selections\\":[[[\\"0-1-2\\",\\"human0\\"]],[[\\"human\\",0],[\\"{\\\\\\"name\\\\\\":\\\\\\"asd\\\\\\"}\\",1],[\\"{\\\\\\"name\\\\\\":\\\\\\"String\\\\\\"}\\",2]],[[0,0]],\\"v0\\"]}"`
  );
...
test('version check', async () => {
  ...
  expect(cacheBackupv1).toMatchInlineSnapshot(
    `"{\\"version\\":\\"v1\\",\\"cache\\":{\\"query\\":{\\"human0\\":{\\"__typename\\":\\"Human\\",\\"id\\":\\"1\\",\\"name\\":\\"asd\\"}}},\\"normalizedCache\\":{\\"Human1\\":{\\"__typename\\":\\"Human\\",\\"id\\":\\"1\\",\\"name\\":\\"asd\\"}},\\"selections\\":[[[\\"0-1-2\\",\\"human0\\"]],[[\\"human\\",0],[\\"{\\\\\\"name\\\\\\":\\\\\\"asd\\\\\\"}\\",1],[\\"{\\\\\\"name\\\\\\":\\\\\\"String\\\\\\"}\\",2]],[[0,0]],\\"v0\\"]}"`
  );
